...
fn test_locale_en_messages() {
    ...
    assert_eq!(t!("invalid_due_day", locale = locale), "Due day must be between 1 and 28.");
...
fn test_locale_ptbr_messages() {
    ...
    assert_eq!(t!("invalid_due_day", locale = locale), "O dia de vencimento deve estar entre 1 e 28.");
